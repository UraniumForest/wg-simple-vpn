...
- Create a hostname (select "A" in the "type" field and enter a random IP in the "IPv4" field, as your router will automatically update it with your public IP) and enable DDNS for it: 
