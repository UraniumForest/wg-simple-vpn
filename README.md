...
If you want to host this tool in a virtual machine, you can use this OVA to import a VM with all the software needed already installed (minimal installation of **Debian 13 (Trixie)**): 
